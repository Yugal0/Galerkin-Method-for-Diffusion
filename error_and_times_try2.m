...
for iTry=1:NTry
    for iN=1:length(N_list)
        ...
        for iQd=iN:length(QdPts_list)
            ...
            Cs_err_sqr_sum = sum((C_PDEPE(:,end) - Cs_sol_SP(:)).^2);
        ...
        if(iN==length(N_list))
                ...
                save(sprintf("err_times_data_"+"NewModal_"+pStruct.FvsCprofile+"_"+pStruct.Deltavstauprofile+"_Try"+iTry+"_default_digits"+".mat"),"-fromstruct",s)
        end
...
for ii=1:NTry
    file_name="err_times_data_NewModal_"+"nmc811AMIDRFitted5"+"_testCrate_Try"+ii+"_default_digits";
